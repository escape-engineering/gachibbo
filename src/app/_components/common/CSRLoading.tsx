...
const CSRLoading = ({ isLoading }: Props) => {
  return (
    <div
      className={`${
        isLoading ? 'block' : 'hidden'
      } fixed z-10 top-0 left-0 w-full h-full flex flex-col justify-center items-center bg-[#000000] bg-opacity-30`}
    >
